...
def resize_unstructured_images(unstructured_path: str, new_lr_sizes: List[str] = ["LR-32", "LR-64"]):
    """
    Resizes the unstructured tree with the LR images to the given sizes
    defined in "new_lr_sizes". The original images will have a 512x512 size
    when generated by the code available at "quiscampi.py" or "scface.py".
    """
...
def resize_structured_images(structured_path: str, new_lr_sizes: List[str] = ["LR-32", "LR-64"]):
    """
    Resizes the structured tree with the LR images to the given sizes
    defined in "new_lr_sizes". The original images will have a 512x512 size
    when generated by the code available at "quiscampi.py" or "scface.py".
    """
    for dir in new_lr_sizes:
